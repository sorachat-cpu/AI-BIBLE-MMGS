        ...
        const shot = await runVideoEngine(
          {
            ...
            // WF1 has four beats to get through (pin -> fast zoom -> cloud layer -> land).
            // At the old 5s ceiling the model simply dropped beats; 10s is what makes the
            // full descent legible, and is the provider's real ceiling.
            duration_seconds: 10,
          },
          options
        );
